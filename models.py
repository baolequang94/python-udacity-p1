...
class NearEarthObject:
    ...
    def __init__(self, pha, pdes='', name=None, diameter=float('nan')):
    ...
    def fullname(self):
        ...
        name = " " + self.name if bool(self.name) else ''
...
class CloseApproach:
    ...
    def serialize(self, isCsv=False):
        """Return `Return serialize of close approaches and its NEO object."""
        serializedResult = {
            "datetime_utc": self.time_str,
            "distance_au": self.distance,
            "velocity_km_s": self.velocity,
        }
        serializedNeo = self.neo.serialize()
        if isCsv:
            serializedResult = {**serializedResult, **serializedNeo}
        else:
            serializedResult["neo"] = serializedNeo
